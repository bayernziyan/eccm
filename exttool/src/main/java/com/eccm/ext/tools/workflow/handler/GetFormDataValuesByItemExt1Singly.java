 ...
 */
public class GetFormDataValuesByItemExt1Singly extends WorkflowActionHandler {
	private static final Logger LOG = Logger.getLogger(GetFormDataValuesByItemExt1Singly.class);
	
	public static final String name = "get_form_data_itemext1_single";	
	 ...
	 */
	public static final String param_out_map = name+"_out_getformdata_byext1_hashmap";
	...
	public void doHandler(WorkflowAction action,Connection conn) {
		...
		try{	
			...
			LOG.info("getFormDataValueByItemExt1List==============");
			HashMap<String,String> map = WorkflowUtil.getFormDataValueByItemExt1List(conn,(List<String>)_list, action.getWfBean().getFormDataId(),action.getWfBean().getFormId());
			LOG.info("getFormDataValueByItemExt1List=============="+(null == map));
			if(null != map) {
	...
	public GetFormDataValuesByItemExt1Singly(){}
	public GetFormDataValuesByItemExt1Singly(HashMap<String,ArrayList<String>> argRelationShip){
